<?php
    include_once($_SERVER['DOCUMENT_ROOT'] . '/PHP_My_SQL_Projects/Project-12 E-Commerce Website using PHP and MySQL/includes/connect.php');
           ...
           while ($row = mysqli_fetch_assoc($result_query)) {
               ...
               echo "<div class='col-md-4 mb-2'>
                   <div class='card'>
                       ...
                       <div class='card-body'> <!-- Fixed class attribute -->
   ...
   function search_product()
   {
       ...
       if (isset($_GET['search_data_product'])) {
           ...
           $num_of_rows = mysqli_num_rows($result_query);
           if ($num_of_rows == 0) {
               echo "<h2 class='text-center text-danger'>No result match. No products found!</h2>";
           }
           while ($row = mysqli_fetch_assoc($result_query)) {
               $product_id = $row['product_id'];
               $product_title = $row['product_title'];
        ...
        if(!isset($_GEt['edit_account'])){
           if(!isset($_GEt['my_orders'])){
              if(!isset($_GEt['delete_account'])){
                 ...
                 if($row_count>0){
                    echo "<h3>You have <span class='text-center text-success mt-5 mb-2'>$row_count </span>pending orders</h3>
